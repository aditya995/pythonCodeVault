...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_HIMETRIC', 'LoadPictureConstants', 'Gray',
           'Color', 'OLE_OPTEXCLUSIVE', 'OLE_ENABLEDEFAULTBOOL',
           'Monochrome', 'OLE_YPOS_CONTAINER', 'OLE_CANCELBOOL',
           'OLE_YSIZE_HIMETRIC', 'OLE_HANDLE', 'Default', 'FONTBOLD',
           'OLE_XPOS_PIXELS', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'IPicture', 'IFontEventsDisp', 'Picture', 'FONTSIZE',
           'FONTITALIC', 'IFontDisp', 'OLE_YSIZE_CONTAINER',
           'StdPicture', 'VgaColor', 'Checked', 'OLE_YPOS_HIMETRIC',
           'FONTSTRIKETHROUGH', 'OLE_XSIZE_CONTAINER', 'OLE_COLOR',
           'OLE_YSIZE_PIXELS', 'FONTNAME', 'OLE_XPOS_CONTAINER',
           'OLE_TRISTATE', 'FontEvents', 'StdFont', 'IFont',
           'IPictureDisp', 'Unchecked', 'FONTUNDERSCORE',
           'OLE_XPOS_HIMETRIC', 'Font']
